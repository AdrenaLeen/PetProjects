...
{
    Console.WriteLine("=> Использование индексов и диапазонов.");
    ...
    // Вывести имя
    foreach (var itm in gothicBands[0..2]) Console.Write($"{itm}, ");
    Console.WriteLine("\n");

    // Конец диапазона является исключающим
    Range r = 0..2;
    // Вывести имя
    foreach (var itm in gothicBands[r]) Console.Write($"{itm}, ");
    Console.WriteLine("\n");
    ...
    Console.WriteLine($"Длина массива: {gothicBands[..].Length}");
    Console.WriteLine($"Длина массива: {gothicBands[0..3].Length}");
    Console.WriteLine($"Длина массива: {gothicBands[0..^0].Length}");
}